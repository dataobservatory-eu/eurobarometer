...
The `read_sav_gesis()` function is a wrapper with [haven::read_sav](https://haven.tidyverse.org/reference/read_spss.html) with the following modifications:
...
- The original, labelled survey variables are stored as `declared`, which has many advantages compared to the labelled class used by haven.
